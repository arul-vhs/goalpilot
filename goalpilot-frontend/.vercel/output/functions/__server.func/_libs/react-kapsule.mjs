...
import { o as omit } from "./jerrypick.mjs";
...
function index(kapsuleComponent) {
  ...
  return /* @__PURE__ */ reactExports.forwardRef(function(props, ref) {
    ...
    Object.keys(omit(props, [].concat(_toConsumableArray(methodNames), _toConsumableArray(initPropNames)))).filter(function(p) {
...
function useEffectOnce(effect) {
  ...
  var _useState = reactExports.useState(0), _useState2 = _slicedToArray(_useState, 2);
  _useState2[0];
